...
M.manifest = {
  list_forces = {
    desc = "Every force on the server: name, player count, connected player count. Takes no arguments.",
  },
  list_players = {
    desc = "Every player belonging to one force: name, connected, admin.",
  },
  current_research = {
...
-- force name would make no sense (CONTEXT.md: force is reserved and injected
-- on every OTHER tool, but a provider never declares params it doesn't use).
